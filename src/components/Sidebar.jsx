...
function Sidebar() {
    ...
    return (
        <div className="w-72 flex flex-col min-h-screen bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800  transition-colors duration-300">
            ...
            <div className="px-6 font-bold mb-6 cursor-pointer py-4 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-red-600  transition-colors duration-300">
                Logout
            </div>
        </div>
    );
